...
class FormData(models.Model):
    ...
    created_by = models.ForeignKey(
        to=SystemUser, on_delete=models.CASCADE, related_name="form_data_created"
    )
...
class PendingDataBatch(models.Model):
    ...
    user = models.ForeignKey(
        to=SystemUser, on_delete=models.CASCADE, related_name="user_pending_data_batch"
    )
    name = models.TextField()
...
class PendingDataBatchComments(models.Model):
    ...
    user = models.ForeignKey(
        to=SystemUser, on_delete=models.CASCADE, related_name="user_batch_comment"
    )
...
class PendingFormData(models.Model):
    name = models.TextField()
    form = models.ForeignKey(
        to=Forms, on_delete=models.CASCADE, related_name="pending_form_form_data"
    )
...
class PendingDataApproval(models.Model):
    batch = models.ForeignKey(
        to=PendingDataBatch, on_delete=models.CASCADE, related_name="batch_approval"
    )
    user = models.ForeignKey(
        to=SystemUser,
        on_delete=models.CASCADE,
    ...
    level = models.ForeignKey(
        to=Levels, on_delete=models.CASCADE, related_name="level_assigned_pending_data"
    )
    status = models.IntegerField(
        choices=DataApprovalStatus.FieldStr.items(), default=DataApprovalStatus.pending
    )
...
class PendingAnswers(models.Model):
    pending_data = models.ForeignKey(
        to=PendingFormData, on_delete=models.CASCADE, related_name="pending_data_answer"
    )
    question = models.ForeignKey(
        to=Questions, on_delete=models.CASCADE, related_name="question_pending_answer"
    )
    name = models.TextField(null=True, default=None)
    value = models.FloatField(null=True, default=None)
    options = models.JSONField(default=None, null=True)
    created_by = models.ForeignKey(
        to=SystemUser, on_delete=models.CASCADE, related_name="pending_answer_created"
    )
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(default=None, null=True)
...
class Answers(models.Model):
    ...
    def to_data_frame(self) -> dict:
        ...
        if q.type in [
            ...
            answer = Administration.objects.get(pk=self.value).administration_column
        else:
            answer = self.value
        return {qname: answer}
...
class AnswerHistory(models.Model):
    data = models.ForeignKey(
        to=FormData, on_delete=models.CASCADE, related_name="data_answer_history"
    )
    question = models.ForeignKey(
        to=Questions, on_delete=models.CASCADE, related_name="question_answer_history"
    )
    name = models.TextField(null=True, default=None)
    value = models.FloatField(null=True, default=None)
    options = models.JSONField(default=None, null=True)
    created_by = models.ForeignKey(
        to=SystemUser, on_delete=models.CASCADE, related_name="answer_history_created"
    )
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(default=None, null=True)
...
class ViewPendingDataApproval(models.Model):
    ...
    level = models.ForeignKey(
        to=Levels, on_delete=models.DO_NOTHING, related_name="level_view_pending_data"
    )
    batch = models.ForeignKey(
        to=PendingDataBatch,
        on_delete=models.DO_NOTHING,
...
class ViewDataOptions(models.Model):
    id = models.BigIntegerField(primary_key=True)
    data = models.ForeignKey(
        to=FormData, on_delete=models.DO_NOTHING, related_name="data_view_data_options"
    )
    administration = models.ForeignKey(
        to=Administration,
        on_delete=models.DO_NOTHING,
    ...
    form = models.ForeignKey(
        to=Forms, on_delete=models.DO_NOTHING, related_name="form_view_data_options"
    )
    options = models.JSONField(default=None, null=True)
...
class ViewOptions(models.Model):
    id = models.BigIntegerField(primary_key=True)
    data = models.ForeignKey(
        to=FormData, on_delete=models.DO_NOTHING, related_name="data_view_options"
    )
    administration = models.ForeignKey(
        to=Administration,
        on_delete=models.DO_NOTHING,
    ...
    question = models.ForeignKey(
        to=Questions, on_delete=models.DO_NOTHING, related_name="question_view_options"
    )
    answer = models.ForeignKey(
        to=Answers, on_delete=models.DO_NOTHING, related_name="answer_view_options"
    )
    form = models.ForeignKey(
...
class ViewJMPData(models.Model):
    id = models.BigIntegerField(primary_key=True)
    data = models.ForeignKey(
        to=FormData, on_delete=models.DO_NOTHING, related_name="data_view_jmp_data"
    )
    path = models.TextField(null=True, default=None)
    form = models.ForeignKey(
        to=Forms, on_delete=models.DO_NOTHING, related_name="form_view_jmp_data"
    )
    name = models.TextField()
    ...
    @property
    def serialize(self):
        return {"data_id": self.data_id, "name": self.name, "level": self.level}
...
class ViewJMPCount(models.Model):
    ...
    path = models.TextField(null=True, default=None)
    form = models.ForeignKey(
        to=Forms, on_delete=models.DO_NOTHING, related_name="form_view_jmp_count"
    )
    name = models.TextField()
    level = models.TextField()
